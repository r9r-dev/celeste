...
## Changements
Ce projet utilise changie pour les releases et notes de version.
Après avoir complété un travail, lancer la commande suivante :
changie new -k {kind} -b {body}

{kind} peut avoir les valeurs suivantes :
Added
Changed
Deprecated
Removed
